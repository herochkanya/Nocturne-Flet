...
class AppColors:
    ...
    BG_MAIN = "#161616"
    BG_CARD = "#0D0D0D"
    BG_CARD_2 = "#2F3035"    # Колір карток при наведенні

    # --- ACCENTS ---
    ACCENT = ft.Colors.BLUE_ACCENT         # Основний акцент (синій)
    HOVER_LINK = ft.Colors.BLUE_400       # Колір посилань при наведенні

    PROGRESS_BAR = "white10"

    TEXT_PRIMARY = ft.Colors.WHITE        # Головний текст / назви треків
    TEXT_MUTED = "white38"                # Текст на світлому фоні (наприклад, всередині play_btn)
    
    ICON_ACTIVE = ft.Colors.WHITE         # Активні іконки
    ICON_MUTED = "white30"                # Тьмяні кнопки (Shuffle/Repeat вимкнені)
    ICON_SEMI_MUTED = "white24"           # Плейсхолдери ноти
    ICON_DARK = "black"                   # Іконка всередині білої кнопки Play

    # --- SLIDERS ---
    SLIDER_ACTIVE = ft.Colors.WHITE
    SLIDER_INACTIVE = "white12"